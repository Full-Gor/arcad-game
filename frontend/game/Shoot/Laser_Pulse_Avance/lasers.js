// laser_pulsed_simple.js - Boule d'énergie qui traverse des murs énergétiques
...
export function updatePulsingLaserSimple(laser) {
    ...
    // Pulsation de la boule
    laser.coreSize = 12 + Math.sin(laser.pulsePhase) * 4;
...
export function drawPulsingLaserSimple(ctx, laser) {
    ...
    // Halo externe de la boule
    const outerGrad = ctx.createRadialGradient(
        laser.x, laser.y, 0,
        laser.x, laser.y, laser.coreSize * 3
    );
    outerGrad.addColorStop(0, laser.color + '80');
    outerGrad.addColorStop(0.3, laser.color + '40');
    ...
    coreGrad.addColorStop(0.4, laser.color);
    coreGrad.addColorStop(0.8, laser.color + 'CC');
    coreGrad.addColorStop(1, laser.color + '80');
